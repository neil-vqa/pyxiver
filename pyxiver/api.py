...
def get_all(query, max_results=10, sort_by='relevance', sort_order='descending'):
    """
    ...
    request = RequestPapers(query, max_results, sort_by, sort_order)
    ...
    if response['status'] == 'fail':
        ...
        result = Papers(response['content'])
        return result
